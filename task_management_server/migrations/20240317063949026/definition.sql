...
--
-- Class EventTypes as table event_types
--
...
--
-- Class ProfilePhotos as table profile_photos
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('task_management', '20240317063949026', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240317063949026', "timestamp" = now();
