  ...
  $Res call({
    ...
    return _then(_$UserAuthImpl(
      isSignedIn: null == isSignedIn
          ...
          : isSignedIn // ignore: cast_nullable_to_non_nullable
              as bool,
      uid: freezed == uid ? _value.uid! : uid,
      email: freezed == email
          ? _value.email
          : email // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$UserAuthImpl implements _UserAuth {
  ...
  @override
  String toString() {
    return 'UserAuth(isSignedIn: $isSignedIn, uid: $uid, email: $email, photoURL: $photoURL, displayName: $displayName)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, isSignedIn,
      const DeepCollectionEquality().hash(uid), email, photoURL, displayName);
...
abstract class _UserAuth implements UserAuth {
  factory _UserAuth(
      ...
      final String? email,
      final String? photoURL,
      final String? displayName}) = _$UserAuthImpl;
